...
//                 WHERE guessed_id = $6
//             `;
//             await db.query(updateQuery, [guessed_gender, guessed_weight, guessed_size, guessed_names, guessed_birthdate, guessed_id]);
...
//                 VALUES ($1, $2, $3, $4, $5) RETURNING guessed_id
//             `;
//             const insertResult = await db.query(insertQuery, [guessed_gender, guessed_weight, guessed_size, guessed_names, guessed_birthdate]);
//             const guessed_id = insertResult.rows[0].guessed_id;
